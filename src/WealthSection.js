    ...
    return (
      <div className='donut' id='wealth'>
        <div className='container'>
          ...
          <br />
          <div>The richest candidate in <span className='bold'>AAP</span> is <span className='bold'>{this.props.majorPartiesArr[0].richestCandidate.candidate_name}</span> contesting from <span className='italics'>{this.props.majorPartiesArr[0].richestCandidate.constituency}</span> seat with net assets of <span className='italics'>Rs. {formatNumber(this.props.majorPartiesArr[0].richestCandidate.net_assets)} (~ US$ {formatNumberUS(Math.round(this.props.majorPartiesArr[0].richestCandidate.net_assets))})</span>, in <span className='bold'>NDA</span> is <span className='bold'>{this.props.majorPartiesArr[1].richestCandidate.candidate_name}</span> contesting from <span className='italics'>{this.props.majorPartiesArr[1].richestCandidate.constituency}</span> seat with net assets of <span className='italics'>Rs. {formatNumber(this.props.majorPartiesArr[1].richestCandidate.net_assets)} (~ US$ {formatNumberUS(Math.round(this.props.majorPartiesArr[1].richestCandidate.net_assets))})</span> and in <span className='bold'>UPA</span> is <span className='bold'>{this.props.majorPartiesArr[2].richestCandidate.candidate_name}</span> contesting from <span className='italics'>{this.props.majorPartiesArr[2].richestCandidate.constituency}</span> seat with net assets of <span className='italics'>Rs. {formatNumber(this.props.majorPartiesArr[2].richestCandidate.net_assets)} (~ US$ {formatNumberUS(Math.round(this.props.majorPartiesArr[2].richestCandidate.net_assets))})</span>.</div>
          <table>
            <thead>
              <tr>
