  ...
  return (
    <div className="App">
      ...
      <div className="container">
        ...
        <div><span className='italics'>3 candidates (<span className='bold'>Imran Khan, Pratap Chandra</span> and <span className='bold'>Sadeque Muniroddin Shaikh</span>) are contesting from multiple seats.</span> Bharatiya Janata Party (BJP), Janata Dal (United) (JDU) and Lok Janshakti Party (LJP) are in a pre-poll alliance National Democratic Alliance (NDA) and Indian National Congress (INC) and Rashtriya Janata Dat (RJD) are in a pre-poll alliance United Progressive Alliance (UPA). Apart from the 2 pre-poll alliances, Aam Aadmi Party (AAP) (contesting on all 70 seats) and Bahujan Samaj Party (BSP) (contesting on 68 out of 70 seats) are the other 2 major parties in this elections.</div>
        <br />
